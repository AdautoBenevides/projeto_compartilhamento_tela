...
// WebRTC ICE servers (STUN + TURN for cross-network)
// TURN server URL is configured via env var TURN_URL, TURN_USERNAME, TURN_CREDENTIAL
export function getIceServers(turnUrl?: string, turnUsername?: string, turnCredential?: string): RTCIceServer[] {
...
// Default ICE servers (STUN only - no TURN configured)
